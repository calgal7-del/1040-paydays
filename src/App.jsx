  ...
  summary: "A simple question at the end of a call centre shift changed the way I thought about time, money, and the value of one ordinary hour.",
  ...
  caption: "Every hour funds something. Make sure it's funding the life you actually want.",
  quote: {
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "People couldn't volunteer fast enough.",
        "Leaving an hour early felt like winning.",
        "One less hour answering phones.",
        "One more hour at home.",
        "Who wouldn't want that?",
        "At first, I raised my hand too.",
        "An hour didn't seem like much.",
        "I had already worked most of the day.",
        "What difference could sixty minutes really make?"
      ]
    },
    {
      ...
      paragraphs: [
        ...
        "Sometimes two.",
        "No one walked out thinking they had just given up part of their retirement.",
        "They were simply happy to be leaving work early.",
        "Then something else occurred to me.",
        "The company wasn't offering early departures to be generous.",
        "It was saving money.",
        "One employee leaving an hour early wasn't a big deal.",
        "Twenty employees leaving an hour early was.",
        "Week after week, those savings added up.",
        "The company understood something I hadn't.",
        "Small amounts become big amounts when they're repeated often enough.",
        "Walking home one afternoon, I had a thought.",
        "If one hour mattered that much to my employer...",
        "Maybe it should matter that much to me."
      ]
    },
    {
      ...
      paragraphs: [
        ...
        "I was tired.",
        "The sun was shining.",
        "Walking home instead of sitting under fluorescent lights for another hour felt like the right choice.",
        "Those were easy decisions.",
        "Other days, I stayed.",
        "Not because the company wanted me to.",
        "Because I knew exactly what that hour was buying.",
        ...
        "The important thing was making the decision on purpose."
      ]
    },
    {
      ...
      paragraphs: [
        ...
        "Sometimes it funds an afternoon walking home in the sunshine.",
        "Sometimes it funds better health.",
        "Sometimes it funds your career.",
        "Sometimes it funds your future.",
        "None of those choices are wrong.",
        "The important thing is knowing what you're funding.",
        "Whenever I hear someone ask,",
        "\"Who wants to go home?\"",
        "I hear a different question.",
        "\"What is this hour worth to me?\"",
        "Sometimes the answer is another hour's pay.",
        "Sometimes it's an hour I'll never get back.",
        ...
        "Yours.",
        "Every hour funds something.",
        "Make sure it's funding the life you actually want.",
        "Every payday is a decision.",
        "Choose yours."
          ],
        },
...
const FIFTH_ARTICLE = {
  ...
  summary:
    "Long before your investment account grows, something else has to grow first. Wealth is usually the result of years spent becoming the kind of person who knows what to do when opportunity arrives.",
  image: "/article-wealth-before-wealth.png",
  readTime: "5 min read",
  category: "Investing",
  kicker: "WEALTH · PREPARATION · GROWTH",
  alt: "Person reviewing financial notes beside a notebook and cup of coffee",
  caption:
    "Real wealth usually appears long after the habits that created it.",
  quote: {
    strong: "The money isn't first.",
    text: "The person is.",
  },
  sections: [
    {
      ...
      paragraphs: [
        "Years ago someone asked me what I'd do if I suddenly had a million dollars.",
        "I answered quickly.",
        ...
        "Mine didn't.",
        "Later I realized I had answered the easy question.",
        "I never asked myself whether I actually knew how to manage that kind of money.",
      ],
    },
    {
      heading: "Money follows judgment",
      paragraphs: [
        "It's easy to believe that more money solves financial problems.",
        "Sometimes it does.",
        "Sometimes it simply gives old habits more room to grow.",
        "A larger paycheque doesn't decide what's important.",
        "It doesn't recognize a good opportunity.",
        "It doesn't stop an emotional decision.",
        "Those jobs still belong to you.",
      ],
    },
    {
      heading: "The empty glass",
      paragraphs: [
        "Imagine turning on a tap without putting a glass underneath it.",
        "The water keeps flowing.",
        "It spreads across the counter until it disappears down the drain.",
        "Money can do the same thing.",
        "Without direction, a higher income often disappears just as quickly as a smaller one.",
      ],
    },
    {
      heading: "What nobody sees",
      paragraphs: [
        "People notice a growing investment account.",
        "They rarely notice the years before it.",
        "The evenings spent reading.",
        "The first automatic transfer.",
        "The mistake that taught an unforgettable lesson.",
        "The decision to keep investing when the excitement was gone.",
    ...
    },
    {
      ...
      paragraphs: [
        "Before you invest money, you invest in judgment.",
        "You begin to understand how investing works.",
        "You stop chasing every exciting headline.",
        "You become comfortable waiting for good decisions to compound.",
        "Those lessons never appear on a statement.",
        "Their fingerprints do.",
      ],
    },
    {
      heading: "The moment people notice",
      paragraphs: [
        "Eventually your portfolio becomes difficult to ignore.",
        "People assume the money changed your life.",
        "You know the truth.",
        "The change happened years earlier.",
        "The portfolio simply arrived later.",
      ],
    },
    {
      heading: "Build yourself first",
      paragraphs: [
        "I don't think wealth begins with a bigger income.",
        "I think it begins when you become someone who is ready for one.",
        "That doesn't happen overnight.",
        "It happens one ordinary payday at a time.",
        "You learn.",
        "You practice.",
        "You make mistakes while the stakes are still small.",
        "Then one day opportunity arrives.",
        "By then, you're no longer hoping you'll know what to do.",
        "You already do.",
        "The money didn't build the person.",
        "The person built the money.",
      ],
    },
  ],
};
  ...
  summary:
    "Your salary is only part of what your job pays. Workplace benefits, retirement matching, employee discounts, and everyday perks can quietly increase the value of every paycheque.",
  image: "/article-work-perks-paycheque.png",
  readTime: "5 min read",
  category: "Financial Basics",
  kicker: "WORKPLACE BENEFITS · TOTAL COMPENSATION · SAVING",
  alt: "Woman pouring hot chocolate at a workplace appreciation lunch",
  caption:
    "Some of the most valuable parts of a job never appear on your pay stub.",
  quote: {
    strong: "Your salary is only part of what your job pays.",
    text: "The rest often shows up as money you never had to spend.",
  },
  sections: [
    {
      ...
      paragraphs: [
        ...
        "I don't.",
        "Over the years, I've realized that some of the most valuable things I've received from work never appeared on my pay stub.",
        "Retirement matching. Health benefits. Employee discounts. Professional development. The occasional free lunch. More coffee than I should probably admit to.",
        "Even a surprising collection of stainless steel travel mugs.",
        ...
        "Some people argue that employers offer workplace perks instead of paying higher salaries.",
        "Maybe they do.",
        "But if someone wants to help pay for my retirement, cover an expense I already have, or buy me lunch, I am going to smile, say thank you, and enjoy it.",
      ],
    },
    {
      heading: "The benefits you forgot you had",
      paragraphs: [
        "Every workplace is different, but many compensation packages are worth more than the salary printed on the job offer.",
        "Some employers negotiate discounts on hotels, insurance, electronics, cell phone plans, vehicles, or gym memberships.",
        "Others help pay for courses, professional development, retirement savings, counselling, dental care, physiotherapy, prescription costs, or wellness expenses.",
        "The surprising part is not that these employee benefits exist.",
        "It is how many people never use them.",
        "Some companies have employee discount programs that workers never open. Others offer health and wellness benefits that quietly expire at the end of the year.",
        "I know people who worked for the same employer for years without realizing a discount website even existed.",
        "One conversation with a coworker changed the way I looked at workplace benefits.",
        "They mentioned buying new tires through an employee discount.",
        "I had no idea our company offered one.",
        "That sent me looking.",
        "I found discounts on hotels, insurance, electronics, and even a mattress company I had already been considering.",
        "It felt like finding money in the pocket of a jacket I had not worn since last winter.",
        "It also made me wonder how many people pay full price simply because they never thought to look.",
        "Before making a large purchase, spend a few minutes checking what your employer already offers.",
        "It may be one of the easiest ways to save money without changing your lifestyle at all.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Every time.",
        "Imagine walking past a twenty-dollar bill on the sidewalk every payday.",
        "Most of us would stop.",
        "Yet many employees leave matching contributions unclaimed year after year.",
        "If your employer is willing to contribute to your retirement because you contributed too, that is one of the simplest financial wins available to you.",
        "You are being rewarded for doing something your future self already needs.",
        "Health benefits deserve the same attention.",
        "If massage therapy helps with pain, use the coverage.",
        "If you have been putting off seeing a nutritionist, counsellor, dentist, or physiotherapist, check your plan.",
        "If your employer helps pay for orthotics, prescription glasses, or medication, do not leave that value unused.",
        "Those benefits are part of your total compensation.",
        "You have already earned them.",
      ],
    },
    {
      heading: "Enjoy the little extras",
      paragraphs: [
        "Not every workplace perk needs to become a financial strategy.",
        "Sometimes it is simply something pleasant.",
        "A few years ago, I attended a company event where everyone was offered a ride home.",
        "Normally, I would have chosen the cheapest vehicle available.",
        "That night, I decided to enjoy the perk and upgraded to a nicer one for a few dollars more.",
        "A black SUV pulled up.",
        "For twenty minutes, I pretended I was far more important than I actually am.",
        "Would I normally pay extra for that?",
        "Probably not.",
        "But that night, I did not have to pay the full cost myself.",
        "There is nothing wrong with enjoying the occasional lunch, cup of coffee, company event, or travel mug that comes with the job.",
        "You do not have to turn every benefit into a spreadsheet.",
        "Sometimes appreciation is enough.",
      ],
    },
    {
      heading: "My new habit",
      paragraphs: [
        "Before I buy something expensive, I now ask one question.",
        "\"Does my employer already have a deal for this?\"",
        "Sometimes the answer is no.",
        "Other times, it is discounted insurance, a cheaper hotel, employee pricing on electronics, or a lower gym membership.",
        "Once, it was the exact mattress I was planning to buy anyway.",
        "Checking takes only a few minutes.",
        "Those few minutes can save hundreds of dollars and, over the course of a career, possibly thousands.",
        "I have also learned to pay closer attention to benefits that are easy to overlook.",
        "A training course that improves my skills.",
        "A wellness account that covers something I already needed.",
        "A lunch-and-learn that turns out to be genuinely useful.",
        "None of these things feels life-changing on its own.",
        "Together, they quietly increase the value of every paycheque.",
      ],
    },
    {
      heading: "The hidden paycheque",
      paragraphs: [
        "Most people compare jobs by looking at salary.",
        "That makes sense.",
        "It is the easiest number to see.",
        "But salary is only one part of a compensation package.",
        "Two people earning the same amount can end up in very different financial positions if one uses their workplace benefits and the other ignores them.",
        "One receives employer retirement contributions.",
        "The other leaves them unclaimed.",
        "One pays less for insurance, travel, or major purchases.",
        "The other pays full price.",
        "One uses their health benefits before they expire.",
        "The other covers those expenses out of pocket.",
        "Over time, those differences add up.",
        "Not because one person earned more.",
        "Because one person kept more.",
        "That is the hidden paycheque.",
        "It does not arrive as a deposit in your bank account.",
        "It appears as money that never had to leave.",
      ],
    },
    {
      heading: "What you do with the difference",
      paragraphs: [
        "Workplace perks will not build wealth on their own.",
        "The real opportunity comes from what they allow you to do with the money you did not have to spend.",
        "A discount that saves you two hundred dollars can disappear just as quickly as any other money.",
        "Or it can pay down debt, strengthen your emergency fund, or be added to an investment account.",
        "The free lunch is pleasant.",
        "The retirement match is powerful.",
        "The employee discount is useful.",
        "But the lasting value comes from giving the savings somewhere to go.",
        "That is how small workplace benefits can quietly support larger financial goals.",
      ],
    },
    {
      heading: "Look beyond the salary",
      paragraphs: [
        "Most people wait for a raise before they expect to feel wealthier.",
        "Sometimes the easiest raise you will ever receive is already sitting in your employee handbook.",
        "Before assuming your salary is the only thing your job pays, spend a few minutes exploring your benefits, retirement plan, employee discount program, and professional development options.",
        "Use what genuinely improves your life.",
        "Claim the employer match.",
        "Check the discount before paying full price.",
        "Enjoy the occasional free lunch without feeling guilty.",
        "Then give the money you saved a purpose.",
        "Some of the best parts of a job never appear on a pay stub.",
        "They show up as the retirement contribution someone else made on your behalf, the health expense you did not have to pay yourself, or the discount that left more money in your account.",
        "That is the hidden paycheque.",
        "Not extra money that arrived.",
        "Money that never had to leave.",
        "Sometimes building wealth is not about earning more.",
        "It is about recognizing everything you have already earned.",
      ],
    },
  ],
};
