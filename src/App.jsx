    ...
    const NINETEENTH_ARTICLE = {
      id: "when-normal-gets-more-expensive",
      title: "When Normal Gets More Expensive",
      summary: "Lifestyle creep does not usually arrive as one reckless purchase. It happens quietly, when the premium version slowly starts to feel ordinary.",
      ...
      caption: "Lifestyle creep is the moment your definition of normal quietly becomes more expensive.",
      quote: {
        strong: "Success hadn't changed who I was.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "It wasn't where we bought our weekly groceries.",
            "It was the kind of place you visited once or twice a year if you wanted a special dessert at Christmas or for a birthday.",
            "The shelves weren't packed from floor to ceiling like a regular grocery store.",
            "There was less food, but somehow everything looked more expensive.",
            "The employees wore crisp white uniforms.",
            "The deli displayed fresh mozzarella topped with cracked pepper like little works of art.",
            "The desserts looked too pretty to eat.",
            "It was one of those stores where you walked slowly, looked at everything, and almost felt guilty putting anything in your cart.",
          ],
        },
        {
          heading: "Not my kinds of problems",
          paragraphs: [
            "As we wandered through the refrigerated section, we spotted creamy chocolate milk in beautiful glass bottles.",
            "We picked one up.",
            "We talked about buying it.",
            ...
            "Back when I was standing all day as a cashier, I never would have imagined spending an afternoon in a specialty grocery store debating chocolate milk in a glass bottle while talking about booking massages.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Success hadn't changed who I was.",
            "It had quietly changed what felt normal.",
            "Financial experts call it lifestyle creep.",
            "Lifestyle creep happens when your spending gradually increases as your income grows.",
            "What once felt like a luxury slowly becomes something you hardly think twice about.",
            "I think that's a good definition.",
            "But I think there's another way to describe it.",
            "It's the day you suddenly realize your definition of normal has become a little more expensive than it used to be.",
          ],
        },
        {
          heading: "It doesn't happen overnight",
          paragraphs: [
            "Nobody wakes up one morning and decides to spend more money.",
            "It happens quietly.",
            "A nicer grocery store.",
            "A better coffee.",
            "The upgraded hotel because it's only a little more.",
            "The premium version because you've worked hard and can finally afford it.",
            "One decision by itself doesn't matter very much.",
            "The problem is that hundreds of those little decisions slowly become your everyday life.",
            "Eventually you stop noticing them.",
            "They simply become normal.",
            "That's the sneaky part.",
            "Lifestyle creep doesn't feel like extravagance.",
            "It feels ordinary.",
          ],
        },
        {
          heading: "This isn't about guilt",
          paragraphs: [
            "Please don't misunderstand me.",
            "I'm not saying you shouldn't enjoy the rewards of your hard work.",
            "You absolutely should.",
            "If you've spent years saving, investing, and making smart decisions, you've earned the right to enjoy life.",
            "I still smile when I think about that grocery store.",
            "I probably would buy the chocolate milk today.",
            "I'd probably enjoy every sip.",
            "The point isn't that the chocolate milk was a bad purchase.",
            "The point is that it made me stop and notice how much my definition of normal had changed.",
            "Sometimes that's a healthy thing to do.",
          ],
        },
        {
          heading: "Spend more where it matters",
          paragraphs: [
            "As I've gotten older, I've realized something.",
            "Some things deserve every extra dollar.",
            "If your feet ache after standing all day, buy the best shoes you can comfortably afford.",
            "You'll appreciate them every single day.",
            "Buy the mattress that helps you sleep.",
            "Buy the office chair that saves your back.",
            "Buy the winter coat that keeps you warm when the temperature drops.",
            "Those things improve your quality of life.",
            "They're worth paying for.",
            "But not everything deserves the premium version.",
            "Not every kitchen gadget.",
            "Not every grocery trip.",
            "Not every household item.",
            "Sometimes the regular version already does exactly what you need.",
            "Sometimes paying twice as much doesn't make life twice as good.",
            "Sometimes it just makes life twice as expensive.",
          ],
        },
        {
          heading: "One question changed the way I spend",
          paragraphs: [
            "These days, before I buy something, I ask myself one simple question.",
            "\"Am I paying for something that will genuinely improve my life, or has my definition of normal quietly become more expensive?\"",
            "Sometimes the answer is easy.",
            "Better shoes?",
            "Absolutely.",
            "A quality mattress?",
            "Without question.",
            "A tool I'll use for the next twenty years?",
            "Money well spent.",
            "Other times...",
            "I'm not so sure.",
            "And when I'm not sure, I remind myself of that afternoon in the grocery store.",
            "Because that little bottle of chocolate milk taught me something I never expected.",
            "Sometimes the smartest financial decisions aren't the big ones.",
            "They're the little moments when you quietly decide,",
            "\"The regular one is just fine.\"",
          ],
        },
        {
          heading: "The cost of every upgrade",
          paragraphs: [
            "Here's the interesting thing.",
            "One premium purchase won't stop you from becoming wealthy.",
            "One bottle of chocolate milk won't change your retirement.",
            "One upgraded coffee maker won't ruin your financial future.",
            "That's not how wealth works.",
            "Wealth is built through patterns.",
            "It's built by the small decisions we make over and over again.",
            "The same is true for lifestyle creep.",
            "It rarely shows up as one huge purchase.",
            "It quietly slips into your life through hundreds of little upgrades.",
            "None of them seem like a big deal.",
            "Until one day you look around and realize your normal has become surprisingly expensive.",
          ],
        },
        {
          heading: "Investing in contentment",
          paragraphs: [
            "When people think about investing, they usually think about the stock market.",
            "I do too.",
            "But I've started thinking about another kind of investment.",
            "Investing in contentment.",
            "Being genuinely happy with something that already does the job.",
            "Not because I have to settle.",
            "Because I've learned that more expensive doesn't always mean more enjoyable.",
            "The regular grocery store still has everything I need.",
            "The regular coffee still tastes pretty good.",
            "The regular kitchen tools still make wonderful meals.",
            "Being content with enough is one of the most valuable financial habits I've ever developed.",
          ],
        },
        {
          heading: "The regular one might be enough",
          paragraphs: [
            "The next time you need to replace something, don't start by looking at the most expensive version.",
            "Start by asking yourself what you actually need.",
            "Then ask one more question.",
            "\"If I buy the regular one instead, what am I really giving up?\"",
            "Sometimes the answer will be obvious.",
            "Comfort.",
            "Durability.",
            "Something you'll appreciate every single day.",
            "Buy the better one.",
            "Enjoy it.",
            "You earned it.",
            "Other times...",
            "The answer might be almost nothing.",
            "If you're intentionally saving for retirement, building your investment portfolio, paying off debt, saving for your family's future, or working toward financial independence, the fancy chocolate milk isn't worth delaying your dreams.",
            "You may discover that contentment costs a lot less than luxury.",
            "Then take the money you didn't spend and put it somewhere your future self will thank you for.",
            "Invest it.",
            "Save it.",
            "Pay down a little debt.",
            "Do that often enough, and one day you'll realize those ordinary decisions quietly built an extraordinary life.",
          ],
        },
        {
          heading: "Looking back",
          paragraphs: [
            "I honestly don't remember whether my sister and I bought the chocolate milk.",
            "I don't remember if we ever booked those massages.",
            "What I remember is laughing.",
            "I remember realizing that I had reached a point in my life where those conversations felt perfectly normal.",
            "That wasn't a bad thing.",
            "It was simply something worth noticing.",
            "Every now and then I still think about that little grocery store.",
            "I picture the white uniforms.",
            "The fresh mozzarella topped with cracked pepper.",
            "The beautiful desserts.",
            "The glass bottles of chocolate milk lined up in the cooler.",
            "Then I smile.",
            "Not because I miss the store.",
            "Because it reminds me to stay intentional.",
          ],
        },
        {
          heading: "The bottom line",
          paragraphs: [
            "Building wealth isn't about saying no to everything.",
            "It's not about buying the cheapest version every time.",
            "It's not about feeling guilty for enjoying the rewards of your hard work.",
            "It's about remembering that every dollar has a purpose.",
            "Spend generously on the things that genuinely improve your life.",
            "Buy the shoes that keep your feet from aching.",
            "Buy the mattress that helps you wake up rested.",
            "Buy the coat that keeps you warm on a freezing winter morning.",
            "Those things matter.",
            "For everything else...",
            "Pause.",
            "Ask yourself whether you're buying something that truly adds value, or whether your definition of normal has quietly become a little more expensive.",
            "Because the goal was never to own the fanciest groceries.",
            "Or the nicest kitchen gadgets.",
            "Or the premium version of everything.",
            "The goal was always much bigger than that.",
            "The goal was to build a life where money gives you choices instead of obligations.",
            "A life where your investments quietly grow while you sleep.",
            "A life where an unexpected bill doesn't keep you awake at night.",
            "A life where you can help the people you love without worrying whether you can afford to.",
            "Those are the luxuries that matter.",
            "And every once in a while, when I'm standing in front of something beautiful that costs a little more than it needs to, I hear myself saying the same words I said to my sister all those years ago.",
            "\"Who am I? These are not my kinds of problems.\"",
            "Then I smile.",
            "Sometimes I buy it.",
            "Sometimes I don't.",
            "The difference now is that I make the decision on purpose.",
          ],
        },
      ],
    };
    ...
    const TWENTIETH_ARTICLE = {
      id: "the-best-things-i-got-from-work-werent-on-my-paycheque",
      title: "The Best Things I Got From Work Weren't on My Paycheque",
      summary: "A paycheque matters, but workplace perks, discounts, benefits, retirement matching, and small everyday extras can quietly make life easier too.",
      image: "/article-work-perks-paycheque.png",
      readTime: "4 min read",
      category: "Financial Basics",
      kicker: "WORK BENEFITS · PERKS · SAVING",
      alt: "Woman pouring hot chocolate at a workplace appreciation lunch",
      caption: "The paycheque pays the bills. The rest quietly makes life a little easier.",
      quote: {
        strong: "The best things I got from work weren't always on my paycheque.",
        text: "Some helped me save money, stay healthy, learn, and build my future.",
      },
      sections: [
        {
          heading: "More than a paycheque",
          paragraphs: [
            "Most people think the only thing they earn at work is a paycheque.",
            "I don't.",
            "Over the years I've realized some of the best things I've received from work never showed up on my pay stub.",
            "Retirement matching.",
            "Employee discounts.",
            "Health benefits.",
            "Education.",
            ...
            "Coffee.",
            "Hot chocolate.",
            "The occasional stainless steel travel mug.",
            "I like to think of it as belonging to the 9-to-5 Club.",
            "The paycheque pays the bills.",
            "The rest quietly makes life a little easier.",
          ],
        },
        {
          heading: "There's more than you think",
          paragraphs: [
            ...
            "Many offer retirement matching, massage therapy, physiotherapy, nutritionists, counselling, prescription shoes, vision care, and dental benefits.",
            ...
            "You might be surprised by what's waiting for you.",
          ],
        },
        {
          heading: "I say yes",
          paragraphs: [
            ...
            "Why yes, I do.",
            "One stays in my vehicle.",
            "One is at my desk.",
            "One is in the kitchen cupboard.",
            "That's three mugs I never had to buy.",
          ],
        },
        {
          heading: "Enjoy the perk",
          paragraphs: [
            "A few years ago I went to a company event.",
            "At the end of the evening everyone was offered a ride home.",
            "Normally I choose the cheapest ride available.",
            ...
            "Would I normally spend the extra money?",
            "Probably not.",
            "But that night it wasn't coming out of my pocket.",
            "I simply enjoyed something my employer had already provided.",
          ],
        },
        {
          heading: "Don't forget the big ones",
          paragraphs: [
            "If I had to choose just one workplace benefit, it would be retirement matching.",
            "If your employer matches part of your retirement savings, don't leave that money behind.",
            "It's one of the few times in life when someone is helping you build your future.",
            "The same goes for your health benefits.",
            "If your plan covers massage therapy and it helps you feel better, book the appointment.",
            "If you've been thinking about seeing a nutritionist, check your coverage.",
            "If you're on your feet all day and your plan helps pay for prescription shoes or orthotics, use them.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "\"Does my 9-to-5 Club already have a deal for this?\"",
            "Sometimes the answer is no.",
            "Sometimes it's a discount on a mattress.",
            "Sometimes it's a better price on a vehicle.",
            "Sometimes it's cheaper insurance.",
            "Sometimes it's employee pricing on electronics.",
            "Sometimes it's a lower gym membership.",
            "Those savings can add up to hundreds, even thousands, of dollars over the years.",
            "Then I do one more thing.",
            "If my workplace discount saves me money...",
            "I don't spend the savings.",
            "I save them.",
            "Invest them.",
            "Or pay down debt.",
            "That's how small workplace perks quietly become long-term wealth.",
          ],
        },
        {
          heading: "Make the most of what you earned",
          paragraphs: [
            "Most people think their salary is the only thing they receive from work.",
            "I think they're missing half the picture.",
            "The best things I got from work weren't always on my paycheque.",
            "Some helped me save money.",
            "Some helped me stay healthy.",
            "Some helped me learn.",
            "Some helped me build my future.",
            "Before you buy something, check your workplace perks.",
            "Before you pay full price, see if your employer has already negotiated a better deal.",
            "Before the end of the year, make sure you've used the benefits you've already earned.",
          ],
        },
        {
          heading: "Let the savings keep working",
          paragraphs: [
            "If work is buying lunch, enjoy it.",
            "If there's free coffee or hot chocolate, have a cup.",
            "If your employer offers retirement matching, take every dollar.",
            "If your benefits cover massage therapy, physiotherapy, a nutritionist, or prescription shoes, use them.",
            "If your company has discounts on vehicles, mattresses, clothing, electronics, insurance, hotels, or gym memberships, check them before reaching for your wallet.",
            "You've already earned those perks.",
            "Make the most of them.",
            "Then let the money you didn't have to spend keep working for you.",
            "Save it.",
            "Invest it.",
            "Pay down debt.",
            "Because building wealth isn't always about earning more money.",
            "Sometimes it's about making the most of the money you've already earned.",
          ],
        },
      ],
    };

    const ARTICLES = [FEATURED_ARTICLE, SECOND_ARTICLE, THIRD_ARTICLE, FOURTH_ARTICLE, FIFTH_ARTICLE, SIXTH_ARTICLE, SEVENTH_ARTICLE, EIGHTH_ARTICLE, NINTH_ARTICLE, TENTH_ARTICLE, ELEVENTH_ARTICLE, TWELFTH_ARTICLE, THIRTEENTH_ARTICLE, FOURTEENTH_ARTICLE, FIFTEENTH_ARTICLE, SIXTEENTH_ARTICLE, SEVENTEENTH_ARTICLE, EIGHTEENTH_ARTICLE, NINETEENTH_ARTICLE, TWENTIETH_ARTICLE];
    ...
    const ARTICLE_FAQS = {
      ...
      "when-normal-gets-more-expensive": [
        {
          question: "What is lifestyle creep?",
          answer: "Lifestyle creep is the gradual increase in spending as your income rises. Things that once felt like luxuries slowly become part of everyday life.",
        },
        {
          question: "Is lifestyle creep always bad?",
          answer: "No. Enjoying the rewards of your hard work is part of life. The goal is to make conscious decisions rather than letting every upgrade become automatic.",
        },
        {
          question: "How can I avoid lifestyle creep?",
          answer: "Before buying something, ask whether it genuinely improves your life or whether you are simply choosing the premium version because it has become your new normal.",
        },
        {
          question: "Should I always buy the cheapest version?",
          answer: "No. Spend more on things that truly improve daily life, such as good shoes, a quality mattress, or a warm winter coat. For everything else, pause first.",
        },
        {
          question: "What's the biggest lesson from this story?",
          answer: "Building wealth does not require giving up everything you enjoy. It means making sure your spending reflects your values instead of your habits.",
        },
      ],
      "the-best-things-i-got-from-work-werent-on-my-paycheque": [
        {
          question: "What workplace benefits should I check first?",
          answer: "Start with retirement matching, health benefits, education support, employee discounts, and any internal perks website your employer provides.",
        },
        {
          question: "Is retirement matching really that important?",
          answer: "Yes. If your employer matches part of your retirement savings, that is money helping build your future. Try not to leave it unused if you can afford to contribute.",
        },
        {
          question: "How can small workplace perks help financially?",
          answer: "Free meals, coffee, travel mugs, discounts, and covered services can reduce money you would otherwise spend. The key is giving those savings a purpose.",
        },
        {
          question: "What should I do with money saved through employee discounts?",
          answer: "Save it, invest it, or use it to pay down debt before it disappears into everyday spending.",
        },
        {
          question: "How often should I review my workplace benefits?",
          answer: "Check at least once a year, before major purchases, and whenever your employer updates benefit plans or discount programs.",
        },
      ],
    };
