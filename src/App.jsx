  ...
  sections: [
    ...
    const FIFTY_SECOND_ARTICLE = {
      ...
      intro: [
        ...
        "Nothing fancy. Just a set I had picked out myself.",
        "The plates I owned were leftovers from other people's kitchens. A few came from relatives. A few survived moves. Some had chips. None of them matched.",
        "They still worked.",
        "For a while, that was enough.",
        "But every time I opened the cupboard, it looked like a collection instead of a choice.",
        "And I knew that living today means not holding on to money so tightly that you can't enjoy the simple things — like having plates that feel like they belong to you.",
        "So I started paying attention whenever I walked through stores.",
        "Not shopping. Just looking.",
        "Eventually I found them.",
        "Plain white plates with a simple rippled edge. Nothing trendy. Nothing that would look dated. Easy to replace if one broke.",
        "I wanted them.",
        "It would have been easy to buy them that day. The old plates had seen better days. But I knew that store. They were always running sales. Every week a new flyer arrived, and something different was discounted. There was a good chance these plates would be too if I waited.",
        "The plates I had still held dinner.",
        "So I left the new ones on the shelf.",
        "Whenever I tell myself I can wait, the decision changes.",
        "Everything looks like a good buy when you're standing in the store.",
        "At home, it usually looks different.",
        "A few weeks later, the flyer arrived.",
        "There they were.",
        "The same white plates.",
        "On sale.",
        "I smiled. I'd waited, I still wanted them, and now the price had come down.",
        "Saturday morning, I drove to the store, found the plates, and headed to the checkout.",
        "\"These aren't on sale,\" the cashier said.",
        "\"I'm pretty sure they are.\"",
        "She checked again.",
        "\"No, not the white ones.\"",
        "For a moment, I thought about buying them anyway. I was already there. The plates were in my cart. The difference wasn't much, and I could afford it.",
        "That's how people often spend more than they planned — not because they need the item, but because they've already invested the time. Once you've driven to the store and found what you wanted, paying a little more feels easier than walking away.",
        "But I had already made my decision.",
        "I was willing to buy the plates at the sale price.",
        "I wasn't willing to buy them at the regular price.",
        "Those were two different decisions.",
        "So I thanked the cashier and left the plates behind.",
        "I was disappointed.",
        "But the mismatched plates in my cupboard had lasted this long.",
        "They could last a little longer.",
        "Later that afternoon, I looked at the flyer again. It didn't say anything about the colour.",
        "So I called the store and asked for the manager.",
        "\"You were right,\" he said after checking. \"The white ones are included.\"",
        "It was Saturday. I wasn't doing anything else, and the store was only a few minutes away.",
        "So I went back.",
        "This time they rang up at the sale price.",
        "The savings weren't life changing.",
        "Neither was the extra trip.",
        "Sometimes we spend more just to avoid a small inconvenience.",
        "For me, one more quick stop was worth keeping a little more money in my pocket.",
        "Looking back, the lesson wasn't waiting for a sale.",
        "The lesson was giving the decision time.",
        "If the plates had never gone on sale, I might have bought them anyway.",
        "But by waiting, I knew I was buying them because I wanted them — not because I happened to be standing in the aisle.",
        "Living today means choosing small things that make your everyday life feel like your own.",
        "Not luxury. Not perfection. Just intention.",
        "Protecting tomorrow means giving those choices space — enough space to think, to wait, and to make sure the purchase is a decision, not a reaction.",
        "Every payday gives us options.",
        "Most of them don't need to be decided immediately.",
        "Sometimes the smartest financial decision — and the simplest way to enjoy your life — is to wait until the choice feels true.",
        "Patience costs nothing.",
        "But it often buys the life you actually want.",
      ],
      sections: [],
    };
    ...
    const FIFTY_THIRD_ARTICLE = {
      ...
      intro: [
        ...
        "Whenever something is stolen, people reach for the same small word.",
        "It was only twenty dollars.",
        "It was just a bike.",
        "It was only some cash.",
        "Only.",
        "I have always found that word revealing, because money is almost never just money.",
        "Imagine someone takes one hundred dollars from your wallet.",
        "To the person who takes it, maybe it means a night out. A tank of gas. A quick purchase made without much thought.",
        "They see the amount.",
        "You see something else.",
        "Maybe that hundred dollars was this week's groceries. Maybe it was a child's birthday present. Maybe it was the first small piece of an emergency fund you had finally started. Maybe it was four or five hours you spent at work instead of at home.",
        "The same hundred dollars. Two entirely different stories.",
        "The older I get, the more I notice how much a dollar carries before it ever reaches a wallet. Someone stood through a long shift for it. Someone answered phones, drove a truck, stocked shelves, cleaned tables, worked overnight, took one more Saturday, missed one more dinner.",
        "By the time money arrives in your hand, it has already cost someone something.",
        "That is why theft is rarely confined to the amount taken. It can take the weekend that no longer happens, the bill that gets pushed forward, the debt that lingers, the small bit of calm that comes from knowing there is enough.",
        "None of that fits neatly on a receipt or a report. Often, it is the real loss.",
        "This has changed the way I think about my own spending, too. When I waste money, I am not only spending dollars. I am spending hours of my life. I am spending choices my future self no longer gets to make.",
        "That does not mean money should never be enjoyed. It means the enjoyment should be worth what it asked of me.",
        "It has also changed the way I handle other people's money. Paying someone back when I said I would. Paying fairly. Leaving the right tip. Returning extra change when a cashier makes a mistake.",
        "These are not grand financial principles. They are ordinary acts of respect. I do not know what that money represents to someone else.",
        "One of the easiest mistakes is judging money only by its amount. Fifty dollars means one thing to a person with plenty of room between paydays. It means something else entirely to someone trying to make the next one arrive.",
        "The number is the same.",
        "The sacrifice behind it is not.",
        "That is why every payday matters. Not because every paycheck is large. Because every paycheck contains a piece of a life: hours given, energy spent, time that will not come back.",
        "That is what gives money its weight. Not the number printed on it. The life exchanged for it.",
        "So the next time someone says, \"It was only a hundred dollars,\" listen to the word only.",
        "To one person, it may be a small amount.",
        "To the person who earned it, it may have been weeks of saving. A goal coming into view. A little more room to breathe.",
        "Money is never just money.",
        "It is time.",
        "It is choices.",
        "It is the quiet shape of what might still be possible.",
      ],
      sections: [],
    };
    ...
    const FIFTY_FOURTH_ARTICLE = {
      ...
      intro: [
        ...
        "For weeks afterward, I walked through my house noticing something I had never paid attention to before.",
        "I wasn't seeing things I owned.",
        "I was seeing future savings.",
        "The can of soup in the pantry. The detergent under the sink. The furnace filter in the basement. The lightbulbs in the closet. The extra batteries tucked away in a drawer.",
        "Each one represented money I wouldn't have to spend later.",
        "Then I realized something else.",
        "Buying something doesn't create savings on its own. Using it does. Every item that gets used is one less purchase a future payday has to make.",
        "Once I noticed it, I couldn't stop.",
        "Most of us think a payday is over when the money leaves our bank account.",
        "I've come to believe that's when a paycheck starts doing its real work.",
        "Your paycheck doesn't disappear.",
        "It changes shape.",
        "A paycheck becomes groceries. Those groceries become dinners. Another paycheck becomes winter boots that keep your feet warm on a freezing morning. Another becomes laundry soap, toothpaste, a full tank of gas, or a stocked medicine cabinet. Before long, much of your income isn't sitting in your bank account anymore. It's working quietly all around you.",
        "That's easy to overlook because we rarely stop to think about it.",
        "I don't walk through my home wondering what everything cost.",
        "I think about the ordinary Fridays that paid for it.",
        "One payday bought the vacuum. Another filled the pantry. Another replaced the tires. Another bought the coffee maker that's used every morning. Another paid for the couch where we end the day.",
        "None of those purchases felt especially important when I made them.",
        "Together, they built a life.",
        "Personal finance usually encourages us to focus on what's next: the next payday, the next raise, the next financial goal. Those things matter.",
        "But if we're always looking ahead, it's easy to miss what yesterday's paychecks have already built.",
        "Take a slow look around your home.",
        "Almost everything within reach exists because a past version of you got up, went to work, earned a paycheck, and decided it was worth bringing home.",
        "That's where gratitude and personal finance meet.",
        "Gratitude helps us recognize what we've already built. Good financial habits help us build even more. One reminds us to appreciate today's life. The other helps create tomorrow's.",
        "I'll always look forward to payday.",
        "But I don't see it as a finish line anymore.",
        "I see it as another opportunity to make a future day a little easier, even if I don't know what that day will bring.",
        "A full pantry.",
        "A warm house.",
        "A reliable car.",
        "Clean towels.",
        ...
        "They were built one payday at a time.",
        "Most of us receive only about 1,040 paydays during our working lives.",
        "Look around.",
        "You're already living inside many of them.",
      ],
      sections: [],
    };
    ...
    const FIFTY_SIXTH_ARTICLE = {
      ...
      sections: [
        {
          heading: "Give Your Savings a Purpose",
          paragraphs: [
